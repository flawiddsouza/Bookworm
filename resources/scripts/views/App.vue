<template>
    <div>
        <nav class="d-f flex-jc-sb flex-ai-c navbar-responsive">
            <div class="d-f flex-ai-c">
                <div class="d-f flex-ai-c">
                    ...
                    <router-link to="/" class="td-n nav-brand">Bookworm</router-link>
                </div>
                ...
                <div class="navbar-menu" :class="{ 'navbar-menu-active': showNavbar }">
                    <router-link to="/" class="ml-1em nav-link" active-class="nav-link-active">Home</router-link>
                    <router-link to="/manage/books" class="ml-1em nav-link" active-class="nav-link-active">Books</router-link>
                    <router-link to="/import" class="ml-1em nav-link" active-class="nav-link-active">Import</router-link>
                </div>
...
.navbar-responsive {
    ...
    background: white;
    box-shadow: 0 1px 0 #e8e8e8, 0 2px 6px rgba(0, 0, 0, 0.05);
}
