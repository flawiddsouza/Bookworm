...
<body>
    <nav class="d-f flex-jc-sb flex-ai-c" style="padding: 0.75em 1.1em; background: white; box-shadow: 0 1px 0 #e8e8e8, 0 2px 6px rgba(0,0,0,.05);">
        <div class="d-f flex-ai-c">
            ...
            <a href="/" class="td-n" style="color: var(--color-text); font-size: 1.05em; font-weight: 700; letter-spacing: -0.01em;">Bookworm</a>
        </div>
    </nav>
    <main style="display: flex; justify-content: center; padding: 2.5em 1em;">
